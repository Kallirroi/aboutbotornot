    ...
    <div className="App">
      ...
      <main> 
        <div className="TLDR"> 
          ...
          <li>Chatbots might not be so smart but many people are lonely. New chatbots will be <a href="#People">playful, entertaining, and personal</a>, consolidating emergent markets in artificial companions, therapists and lovers.</li>
          <li>Changes will <a href="#HR">disproportionately affect people on lower incomes</a> on multiple fronts, as both providers and consumers of services.</li>
        </div>      
        ...
        <div className="chapter"> 
          ...
          <p>A recent <a href="https://www.gartner.com/smarterwithgartner/gartner-predicts-a-virtual-world-of-exponential-change/">Gartner industry report</a> predicted that "by 2020, the average person will have more conversations with bots than with their spouse". In your day-to-day experience of the digital world, you may have noticed the proliferation of chatbots in the spheres of work, customer service, social media and domestic life. Like many new technologies, it seems likely we will learn to live with them long before we have truly understood their societal effects.</p>
          ...
          <p>Is its syntax repetitive or formulaic? The majority of bots, like ours, are fundamentally quite limited when it comes to constructing sentences of their own, relying instead on prompting the user to engage the flow of conversation. They often rely on what the user says to set the "context" for the next step in the dialogue. If you suspect it's a bot, trying giving it some unpredictable inputs and see how it responds. Even the most advanced chatbots today have a hard time responding to highly context-based questions that humans would have no problems with, like a reference back to something you discussed earlier, sarcasm or a joke. </p>
          <p>Is it trying to make you do something, like give up information, or provoke you to give it attention? Some of the most common bots just seek to add to the noise of misinformation, like Twitter bots. Scammer bots on dating apps are also a known phenomenon, while increasingly realistic voice bots like <a href="#Duplex">Google Duplex</a> suggest that new kinds of phone scams could increase too.</p>
        </div>      

        <div id="Surveillance" className="chapter"> 
        ...
        <div id="Duplex" className="chapter"> 
          ...
          <p>In the last few years, both <a href="https://ai.googleblog.com/2018/05/duplex-ai-system-for-natural-conversation.html">Google</a> and <a href="https://blogs.microsoft.com/ai/xiaoice-full-duplex/">Microsoft</a> have released advanced "duplex" chatbots, so-called because they can speak and listen at the same time, closely mimicking the experience of human conversation. After revealing Google Duplex in 2019, the tech giant faced a sharp backlash over the question of consent, for failing to disclose that the person on the other end of the line – in this case a hairdresser receiving a customer booking – that they were speaking to a bot. As the sociologist of technology Zeynep Tufecki <a href="https://twitter.com/zeynep/status/994233568359575552?ref_src=twsrc%5Etfw">responded at the time</a>, echoing sentiments across social media:
        ...
        <div id="People" className="chapter"> 
